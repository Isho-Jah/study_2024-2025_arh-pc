...
Открываем его и заполняем, чтобы решалось выражение f(x)=(5 + x)^2 − 3(рис. @fig:022).

![Заполняем файл](image/22.png){#fig:022 width=70%}

Компилируем программу и проверяем для x=5 (рис. @fig:023).

![Проверяем работу программы](image/23.png){#fig:023 width=70%}

Компилируем программу и проверяем для x=1 (рис. @fig:024).
